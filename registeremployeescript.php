...
if ($usernameresult == $username) {
    ...
    header('Location: ./registeremployee.php?username=error');
    exit();
}
...
if ($phoneresult == $phone) {
    mysqli_close($connection);
    header('Location: ./registeremployee.php?phone=error');
    exit();
}
...
if ($emailerror != '') {
    ...
    mysqli_close($connection);
    header('Location: ./registeremployee.php?email='.$emailerror);
    exit();
}
...
// redirect
mysqli_close($connection);
header('Location: ./registeremployee.php?success=true');
exit();
