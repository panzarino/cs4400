    ...
    <div class="row">
        <div class="col-lg-6 offset-lg-3 text-center">
            ...
            <div class="row">
                ...
                if ($type == 'administrator' || $type == 'administrator-visitor') {
                    echo '<div class="col-md-6 text-center"><a href="" class="btn btn-primary">Manage User</a><br /><br /></div>';
                }
                if ($type == 'administrator' || $type == 'administrator-visitor') {
                    echo '<div class="col-md-6 text-center"><a href="" class="btn btn-primary">Manage Transit</a><br /><br /></div>';
                }
                if ($type == 'administrator' || $type == 'administrator-visitor') {
                    echo '<div class="col-md-6 text-center"><a href="" class="btn btn-primary">Manage Site</a><br /><br /></div>';
                }
                if ($type == 'manager' || $type == 'manager-visitor') {
                    echo '<div class="col-md-6 text-center"><a href="" class="btn btn-primary">Manage Event</a><br /><br /></div>';
                }
                if ($type == 'manager' || $type == 'manager-visitor') {
                ...
                if ($type == 'administrator-visitor' || $type == 'manager-visitor' || $type == 'staff-visitor' || $type == 'visitor') {
                    echo '<div class="col-md-6 text-center"><a href="" class="btn btn-primary">Explore Event</a><br /><br /></div>';
                }
                if ($type == 'administrator-visitor' || $type == 'manager-visitor' || $type == 'staff-visitor' || $type == 'visitor') {
                    echo '<div class="col-md-6 text-center"><a href="" class="btn btn-primary">Explore Site</a><br /><br /></div>';
                }
                if ($type == 'administrator-visitor' || $type == 'manager-visitor' || $type == 'staff-visitor' || $type == 'visitor') {
